...
const MobileMenu = () => {
    return (
        <div className='absolute w-screen h-screen z-10 top-0 left-0 right-0 bottom-0 bg-blue-900'>


         <nav>
             <ul className='w-full pt-20 px-6 text-2xl text-amber-600 flex flex-col items-center justify-center gap-8'>
