...
const Header = () => {
    return (
        <header className='flex gap-2 items-center justify-between px-6 lg:px-40 xl:px-60 pt-4 sticky top-0 z-10'>
            <img src="/logo.png" alt="Visage logo"/>
            <nav>
                <ul className='hidden xl:flex gap-6 font-semibold text-blue-900 *:uppercase xl:text-[14px]'>
            ...
            <div className='hidden xl:block text-[#F96302] font-semibold xl:text-md '>
